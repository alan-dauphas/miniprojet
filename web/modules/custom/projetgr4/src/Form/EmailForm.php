...
//    if(!empty($form_state->getValue('programme_list'))){
//      $programmes_nids = \Drupal::entityQuery('node')->condition('title', $titre)->execute();
//      $user = \Drupal::entityTypeManager()->getStorage('webform_submission')->loadByProperties([
//        'entity_id' => $programmes_nids,]);
//
//      $user_info = [];
//      foreach ($user as $user_id)
//      {
